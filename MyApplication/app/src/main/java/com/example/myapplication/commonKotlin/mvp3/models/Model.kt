package com.example.myapplication.commonKotlin.mvp3.models

import android.os.Handler
import com.example.myapplication.commonKotlin.mvp3.interfaces.IContract
import java.util.*

class Model: IContract.Model {
    ...
    override fun getNextCourse(onFinishedListener: IContract.Model.OnFinishedListener?) {
